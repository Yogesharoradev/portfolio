    ...
    return (
        <Tooltip tip={tip} active={active}>
            <div className='transition-all group'>
                <Link
                    className='transition-all flex justify-center items-center w-[50px] h-[50px] bg-transparent border-none rounded-[10px] cursor-pointer group-hover:bg-neutral_one active:scale-[95%] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-yellow'
                    href={link}
                    target="_blank"
                    rel="noreferrer"
                    ref={ref}
