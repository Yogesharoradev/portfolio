...
const Repos: React.FC = () => {
  ...
  const data = [
    ...
    },
    {
      ...
      description: "This LMS allows users to browse, enroll in, and complete online courses. It features course details, payment processing through PayPal, and a responsive design for seamless access on various devices.",
      image: "",
      website: "",
      language: "React Nodejs PayPal Antd",
      languageColor: "#3178c6",
      stars: "0",
      forks: "0",
    },
